...
public abstract class Game extends JFrame {
 ...
 private ArrayList<GameObject> _ObjectList = new ArrayList<GameObject>();
 private Timer _t;
 ...
 public Game() {
  ...
  getContentPane().setLayout(null);
        ...
        JMenu menuFile = new JMenu("GLaDOS Menu");
        JMenuItem menuFileExit = new JMenuItem("Terminate Testing");
        menuBar.add(menuFile);
        menuFile.add(menuFileExit);
        setJMenuBar(menuBar);
        setTitle("Think with Portals: Now You're Thinking with Portals");
